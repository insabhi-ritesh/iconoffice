...
Padding sendMessageSection(RxList<PlatformFile> selectedFiles, TextEditingController messageController, TicketDetailPageController callController, ticket, BuildContext context) {
    return Padding(
