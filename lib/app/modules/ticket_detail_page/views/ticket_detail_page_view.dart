...
class TicketDetailPageView extends StatelessWidget {
  ...
  static const List<String> stateLabels = [
    'Assigned',
    'Work in Progress',
    'Closed',
  ];
          ...
          child: Scaffold(
            ...
            body: Obx(() {
              ...
              return RefreshIndicator(
                ...
                // ✅ Removed LayoutBuilder, ConstrainedBox, and IntrinsicHeight
                // They caused the crash when ListView children tried to measure
                // their intrinsic height — which is impossible for lazy viewports.
                // The SingleChildScrollView alone is sufficient here.
            ...
            floatingActionButton: tickerFloatActionButton(
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton2<int>(
                    ...
                    items:
                        controller.assignedUsers.map((user) {
