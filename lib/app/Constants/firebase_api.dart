...
//   log('Foreground Message Payload: ${remoteMessage.data}');
...
//   print('Opened App Message Payload: ${message.data}');

//   // Open URL when the notification is clicked
//   // fetchClickAction(message);
// }
...
//   'insabhi_falcann_fmcg',
//   'Falcann Notifications',
//   description:
